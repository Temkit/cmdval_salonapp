...
export default function NewPreConsultationPage() {
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateField("previous_laser_sessions", parseInt(e.target.value) || null)
                        }
                        placeholder="Ex: 6"
                        min={0}
                        className="mt-1.5"
                        ...
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex-1">
                            ...
                            <div className="mt-2 flex gap-2">
                              <Button
                                type="button"
                                variant={zone.is_eligible ? "default" : "outline"}
                                size="sm"
                                onClick={() => updateZone(zone.zone_id, "is_eligible", true)}
                              >
                              ...
                              <Button
                                type="button"
                                variant={!zone.is_eligible ? "destructive" : "outline"}
                                size="sm"
                                onClick={() => updateZone(zone.zone_id, "is_eligible", false)}
                              >
