...
export const Route = createFileRoute("/secretary/sessions/$id")({
  component: SecretarySessionDetailPage,
});
...
function SecretarySessionDetailPage() {
    ...
    return (
      <div className="page-container">
        ...
        <Button asChild variant="outline" className="mt-4">
          <Link to="/secretary/sessions">Retour</Link>
        </Button>
      </div>
    );
  }
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span>
                ...
                >
                  {session.patient_prenom} {session.patient_nom}
                </Link>
                {session.patient_code_carte && (
