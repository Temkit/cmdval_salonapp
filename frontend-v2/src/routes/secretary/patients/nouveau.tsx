...
import { FileText, ShieldCheck, UserPlus, Zap } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Card, CardContent } from "@/components/ui/card";
import { PatientWorkflowStepper } from "@/components/patient-workflow";

export const Route = createFileRoute("/secretary/patients/nouveau")({
  component: SecretaryPatientNouveauPage,
});
  ...
  return (
    <div className="page-container space-y-6 max-w-2xl mx-auto">
      ...
      <Button asChild size="lg" className="w-full">
        <a href="/secretary/pre-consultations/nouveau?from=nouveau-patient">
