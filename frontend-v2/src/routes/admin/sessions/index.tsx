...
import { Activity, Calendar, Clock, User, Stethoscope, Download } from "lucide-react";
...
function AdminSessionsPage() {
  ...
  const handleExportCSV = async () => {
    setExporting(true);
    try {
      const response = await fetch("/api/v1/sessions/export", {
        credentials: "include",
      });
