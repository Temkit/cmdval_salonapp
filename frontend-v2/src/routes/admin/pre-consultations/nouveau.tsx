...
export const Route = createFileRoute("/admin/pre-consultations/nouveau")({
  component: AdminPreConsultationNouveau,
});
    ...
    <div className="page-container space-y-4 sm:space-y-6 max-w-2xl mx-auto">
      ...
      <div className="flex items-center gap-3">
        <Button asChild variant="ghost" size="icon-sm">
          <Link to={fromWorkflow ? "/admin/patients/nouveau" : "/admin/pre-consultations"}>
