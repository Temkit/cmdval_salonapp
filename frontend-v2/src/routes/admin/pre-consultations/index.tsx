...
export const Route = createFileRoute("/admin/pre-consultations/")({
  component: AdminPreConsultationsPage,
});
// Route path managed by TanStack Router file-based routing
        ...
        <div className="space-y-3">
          {data.items.map((pc) => {
            ...
            return (
              <Link
                key={pc.id}
                to={"/admin/pre-consultations/$id" as string}
                params={{ id: pc.id }}
              >
              <Card
