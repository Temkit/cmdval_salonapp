...
export const Route = createFileRoute("/practitioner/agenda")({
  component: PractitionerAgendaPage,
});
...
function PractitionerAgendaPage() {
  ...
  return (
    <div className="page-container space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="heading-2">Feuille de passage</h1>
      ...
      {isError && (
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              {(error as Error)?.message || "Impossible de charger l'agenda"}
            </p>
          ...
          {isLoading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {entries.map((entry: DailyScheduleEntry) => {
                    const status =
